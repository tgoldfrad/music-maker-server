//------------------------------------------------------------------------------------------------//
//                                                                                                //
//                            H e a d F i n g e r i n g R e l a t i o n                           //
//                                                                                                //
//------------------------------------------------------------------------------------------------//
...
/**
 * Class <code>HeadFingeringRelation</code> represents the relation between a note head and
 * a fingering indication.
 *
 * @author Hervé Bitteur
 */
@XmlRootElement(name = "head-fingering")
public class HeadFingeringRelation
        extends AbstractConnection
{
    ...
    {
        final FingeringInter fingering = (FingeringInter) e.getEdgeTarget();

        fingering.checkAbnormal();
    }
    ...
    {
        return constants.fingeringTargetCoeff.getValue();
    }
            ...
            extends ConstantSet
    {
        ...
        private final Scale.Fraction yGapMax = new Scale.Fraction(
                2.0,
                "Maximum vertical gap between fingering center & chord");
